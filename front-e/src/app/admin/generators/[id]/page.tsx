                ...
                {tickets && tickets.content.length > 0 ? (
                  tickets.content.map((ticket) => (
                    <div
                      ...
                      className="group bg-white border border-slate-100 p-4 rounded-2xl hover:shadow-lg hover:border-corporate-blue/20 transition-all cursor-pointer relative overflow-hidden"
                    >
                      <div className="absolute top-0 right-0 p-3 opacity-0 group-hover:opacity-100 transition-opacity">
                         <ArrowLeft className="rotate-180 text-corporate-blue" size={18} />
                      </div>
                      ...
                      <div className="flex justify-between items-start mb-3">
                        <div className="space-y-0.5">
                          ...
                          <h4 className="text-sm font-black text-slate-900 uppercase tracking-tight">{ticket.title}</h4>
                        </div>
                        <StatusBadge status={ticket.status} />
                      </div>

                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 border-t border-slate-50 pt-3">
                        <div>
